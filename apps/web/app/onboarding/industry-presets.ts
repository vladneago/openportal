...
export const INDUSTRY_PRESETS: IndustryPreset[] = [
  ...
  {
    id: "veterinary",
    label: "Cabinet veterinar / Pet shop",
    icon: "🐶",
    description: "Consultații, vaccinare, grooming animale",
    services: [
      { name: "Consultație", durationMinutes: 30, price: "150", category: "Consultații", color: "#0EA5E9" },
      { name: "Vaccinare", durationMinutes: 20, price: "200", category: "Profilactice", color: "#7DD3FC" },
      { name: "Sterilizare", durationMinutes: 120, price: "800", category: "Chirurgie", color: "#0284C7" },
      { name: "Microcip", durationMinutes: 15, price: "120", category: "Identificare", color: "#7DD3FC" },
      { name: "Grooming", durationMinutes: 90, price: "150", category: "Grooming", color: "#BAE6FD" },
    ],
    hours: MON_SAT_9_19,
    suggestedTheme: "medical-trust",
    suggestedTemplate: "veterinary-care",
  },
  {
    id: "automotive",
    label: "Atelier auto / Service",
    icon: "🚗",
    description: "Reparații, revizii, ITP, vulcanizare",
    services: [
      { name: "Revizie tehnică", durationMinutes: 120, price: "300", category: "Revizii", color: "#475569" },
      { name: "ITP pre-verificare", durationMinutes: 60, price: "150", category: "ITP", color: "#64748B" },
      { name: "Schimb ulei + filtre", durationMinutes: 60, price: "250", category: "Mentenanță", color: "#475569" },
      { name: "Diagnoză computerizată", durationMinutes: 45, price: "200", category: "Diagnoză", color: "#1E293B" },
      { name: "Schimb pneuri", durationMinutes: 30, price: "100", category: "Vulcanizare", color: "#64748B" },
    ],
    hours: [
    ...
    suggestedTheme: "professional-clean",
    suggestedTemplate: "auto-service",
  },
  {
    id: "hotel_bnb",
    label: "Hotel / Pensiune / B&B",
    icon: "🏨",
    description: "Rezervări camere, sejururi turistice",
    services: [
      { name: "Cameră dublă standard", durationMinutes: 1440, price: "250", category: "Cazare", color: "#7A9F7A" },
      { name: "Cameră dublă deluxe", durationMinutes: 1440, price: "350", category: "Cazare", color: "#7A9F7A" },
      { name: "Suită familială", durationMinutes: 1440, price: "500", category: "Cazare", color: "#5F8A5F" },
      { name: "Apartament cu vedere", durationMinutes: 1440, price: "600", category: "Cazare", color: "#5F8A5F" },
    ],
    hours: [
    ...
    suggestedTheme: "spa-wellness",
    suggestedTemplate: "hotel-boutique",
  },
  {
    id: "education",
    label: "Cursuri / Training / Școală meserii",
    icon: "🎓",
    description: "Cursuri online + on-site, traininguri",
    services: [
      { name: "Curs Web Development (8 săpt)", durationMinutes: 180, price: "2500", category: "Tehnologie", color: "#7C3AED" },
      { name: "Curs Marketing Digital", durationMinutes: 180, price: "1800", category: "Marketing", color: "#A78BFA" },
      { name: "Workshop UX (weekend)", durationMinutes: 480, price: "800", category: "Workshop", color: "#C4B5FD" },
      { name: "Consultație 1-la-1", durationMinutes: 60, price: "300", category: "Mentoring", color: "#7C3AED" },
    ],
    hours: [
      { dayOfWeek: 1, start: "17:00", end: "21:00" },
      { dayOfWeek: 2, start: "17:00", end: "21:00" },
      { dayOfWeek: 3, start: "17:00", end: "21:00" },
      { dayOfWeek: 4, start: "17:00", end: "21:00" },
      { dayOfWeek: 5, start: "17:00", end: "21:00" },
      { dayOfWeek: 6, start: "09:00", end: "17:00" },
    ],
    suggestedTheme: "professional-clean",
    suggestedTemplate: "education-courses",
  },
  {
    id: "tattoo_studio",
    label: "Tatuaj / Piercing / Body art",
    icon: "✒️",
    description: "Tatuaje, piercing-uri, retouch",
    services: [
      { name: "Consultație design", durationMinutes: 45, price: "0", category: "Consultație", color: "#0F172A" },
      { name: "Tatuaj mic (până la 10 cm)", durationMinutes: 90, price: "500", category: "Tatuaj", color: "#0F172A" },
      { name: "Tatuaj mediu (10-25 cm)", durationMinutes: 180, price: "1200", category: "Tatuaj", color: "#1F2937" },
      { name: "Tatuaj mare (25+ cm, multi-sesiuni)", durationMinutes: 300, price: "2500", category: "Tatuaj", color: "#374151" },
      { name: "Piercing simplu", durationMinutes: 30, price: "150", category: "Piercing", color: "#475569" },
    ],
    hours: MON_SAT_10_20,
    suggestedTheme: "barbershop-bold",
    suggestedTemplate: "tattoo-studio",
  },
  {
    id: "general_business",
